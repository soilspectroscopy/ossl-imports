...
NOTE: The code chunk below this paragraph is hidden. Run once for importing the harmonization rules (L0 to L1). The table is edited online on Google Sheets after the previous definition. Copies are downloaded to github for archiving. Use `CMD + Shift + C` to uncomment chunks.
