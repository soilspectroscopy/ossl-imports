...
This data processing and analysis follow the principles of `tidyverse` (@package_tidyverse) while taking advantage of several other amazing packages, such as `tictoc` (@package_tictoc), `data.table` (@package_datatable), `lubridate` (@package_lubridate), `fs` (@package_fs), `qs` (@package_qs), `openssl` (@package_openssl), `olctools` (@package_olctools), `sf` (@package_sf), and `terra` (@package_terra).
