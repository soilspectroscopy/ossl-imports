...
author: "Tomislav Hengl (tom.hengl@opengeohub.org), Leandro Parente (leandro.parente@opengeohub.org), and Jose Lucas Safanelli (jsafanelli@woodwellclimate.org) - "
...
- `LUCAS.SOIL_corr.Rdata`: VNIR soil spectral reflectances (4200 channels/ window of 0.5 nm from 400 - 2499.5 nm);
- `LUCAS_Topsoil_2009_ESPG4326.csv`: 2009 Database with site and soil analytes (19,860 observations);  
- `LUCAS_spectra_2015.rds`: VNIR soil spectral reflectances (4200 channels/ window of 0.5 nm from 400 - 2499.5 nm);
...
<!-- `r fig_nums("lucas.pnts_sites", "LUCAS locations of sites across the globe.")` -->
