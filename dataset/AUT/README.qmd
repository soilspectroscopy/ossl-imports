...
Authors describe in the paper that the spectra in reflectance units, was transformed to pseudo absorbance. We will convert back to reflectance as all VNIR spectra is being stored as ref.
...
NIR spectral visualization (100 random spectra). **PLEASE NOTE the a bad interpolation between the detectors switch around 1350 nm. Somple splice correction does not work in this case.**
