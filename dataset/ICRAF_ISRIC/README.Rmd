...
author: "Tomislav Hengl (tom.hengl@opengeohub.org), Wanderson Mendes de Sousa (wanderson.mendes@zalf.de) and Jonathan Sanderman (jsanderman@woodwellclimate.org)"
...
Information System (ISIS), which already had the analytical data, and
the spectra were analysed in the World Agroforestry Centre's (ICRAF).
...
#load.pigz(paste0(dir, "ICRAF.RData"))
