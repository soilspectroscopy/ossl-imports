...
Site data, Soil lab data, and Mid-Infrared Spectra (MIR), Visible to
...
```{r}
besb.metadata <- read_excel("BSSL_DB_V002.xlsx", sheet = "BSSL_Soil_Attributes_Dataset")
...
googlesheets4::write_sheet(upload, ss = OSSL.soildata.importing, sheet = "BESB")
