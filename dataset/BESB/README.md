...
| BSSL_DB_V002.xlsx | SOM_gkg | g/kg | oc | iso.10694 | w.pct | ifelse(as.numeric(x) \< 0, NA, as.numeric(x)*(0.58*1.07) / 10) | oc_iso.10694_w.pct |
| BSSL_DB_V002.xlsx | pH_H2O | NA | ph.h2o | usda.a268 | index | ifelse(as.numeric(x) \< 0, NA, as.numeric(x)\*1) | ph.h2o_usda.a268_index |
...
```
    ...
    # A tibble: 10 × 2
       column                    count
       <chr>                     <int>
     1 ca.ext_usda.a722_cmolc.kg 12496
     2 cec_usda.a723_cmolc.kg    12496
     3 clay.tot_usda.a334_w.pct  15107
     4 id.layer_local_c          16084
     5 mg.ext_usda.a724_cmolc.kg 12499
     6 na.ext_usda.a726_cmolc.kg   661
     7 oc_iso.10694_w.pct        13347
     8 ph.h2o_usda.a268_index     3483
     9 sand.tot_usda.c405_w.pct  15125
    10 scan_visnir.600_ref       16084
...
| skim_variable             | n_missing |  mean |    sd |   p0 |   p25 |   p50 |   p75 |  p100 |
|:--------------------------|----------:|------:|------:|-----:|------:|------:|------:|------:|
| scan_visnir.600_ref       |         0 |  0.14 |  0.07 | 0.01 |  0.10 |  0.12 |  0.17 |  0.58 |
| sand.tot_usda.c405_w.pct  |       959 | 54.17 | 28.26 | 0.47 | 26.70 | 61.40 | 80.00 | 95.40 |
| clay.tot_usda.a334_w.pct  |       977 | 31.15 | 21.58 | 0.70 | 13.00 | 24.00 | 48.00 | 96.10 |
| oc_iso.10694_w.pct        |      2737 |  1.31 |  0.89 | 0.08 |  0.70 |  1.06 |  1.68 |  7.49 |
| ph.h2o_usda.a268_index    |     12601 |  4.64 |  0.61 | 3.10 |  4.10 |  4.60 |  5.10 |  7.00 |
...
```
    ...
    # A tibble: 10 × 2
       column                    count
       <chr>                     <int>
     1 ca.ext_usda.a722_cmolc.kg  1344
     2 cec_usda.a723_cmolc.kg     1344
     3 clay.tot_usda.a334_w.pct   1594
     4 id.layer_local_c           1783
     5 mg.ext_usda.a724_cmolc.kg  1345
     6 na.ext_usda.a726_cmolc.kg    57
     7 oc_iso.10694_w.pct         1459
     8 ph.h2o_usda.a268_index      332
     9 sand.tot_usda.c405_w.pct   1594
    10 scan_mir.1000_abs          1783
...
| skim_variable             | n_missing |  mean |    sd |   p0 |   p25 |   p50 |   p75 |  p100 |
|:--------------------------|----------:|------:|------:|-----:|------:|------:|------:|------:|
| scan_mir.1000_abs         |         0 |  2.15 |  0.19 | 1.26 |  2.03 |  2.16 |  2.29 |  2.58 |
...
| oc_iso.10694_w.pct        |       324 |  1.44 |  1.07 | 0.16 |  0.68 |  1.12 |  1.88 |  7.49 |
| ph.h2o_usda.a268_index    |      1451 |  4.58 |  0.60 | 3.40 |  4.10 |  4.50 |  5.00 |  6.30 |
