---
title: "CASSL dataset preparation for the OSSL"
author: 
...
Code repository for preparing and importing the Central African Soil Spectral Library (CASSL) dataset into the Open Soil Spectral Library.
...
Site data, Soil lab data, and Mid-Infrared Spectra (MIR) from the Central African Soil Spectral Library (CASSL). Further information of the dataset can be found in detail at @summerauer2021central.
