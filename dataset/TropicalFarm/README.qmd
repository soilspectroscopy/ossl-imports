---
title: "Tropical farm from Brazilian dataset preparation for the OSSL"
author: 
  - name: Ran Zhi
...
Code repository for preparing and importing the Tropical farm from two Brazilian agricultural areas dataset into the Open Soil Spectral Library.
...
Site data, Soil lab data, and Visible Near-Infrared (Vis-NIR) data from Brazilian agricultural areas. Further information of the dataset can be found in detail at @tavares_spectral_2022.
