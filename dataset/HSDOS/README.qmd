...
Site data, Soil lab data, and Visible Near-Infrared (Vis-NIR) data from the Hungarian Soil Degradation Observation System (HSDOS). Further information of the dataset can be at @meszaros_vis-nir_2025.
...
Spectra is in reflectance, 1 nm interval, but we retain spectra at 2 nm interval. Need splice correction at 1800 nm, but it does not work (probably because the spectra was smoothed).
...
Soil analytical data summary for Vis-NIR. Note: some scans may not be linked with the wetchem.
